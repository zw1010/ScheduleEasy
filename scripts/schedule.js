...
function handleCalenderDayHover() {
    ...
    dayList.forEach((day) => {
        ...
        day.addEventListener('click', () => {
            renderCalenderDay(day);
        });
    });
}

function renderCalenderDay(dayElement) {
    renderCalenderDayStatic(dayElement.dataset.date, dayElement.dataset.day);
}

function renderCalenderDayStatic(date, day) {
    const calenderContainer = document.querySelector('.js-schedule-calender-container');
